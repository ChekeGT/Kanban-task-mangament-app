    ...
    return(
        <div onClick={preventPropagation} className="dark:bg-darkGrey w-[480px] bg-white px-6 py-8 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
                ...
                <input className="dark:bg-darkGrey w-full p-2 rounded-md  border border-gray" placeholder="e.g. Web Design" type="text" />
            </div>
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                    <button className="dark:bg-white bg-mainPurple bg-opacity-10 p-2 text-mainPurple font-bold rounded-full">+ Add New Column</button>
